...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO study_groups (name, description, created_by) VALUES ('$name', '$description', '$created_by')";

    if ($conn->query($sql) === TRUE) {
        $group_id = $conn->insert_id;
        $sql = "INSERT INTO group_memberships (group_id, user_id) VALUES ('$group_id', '$created_by')";
        if ($conn->query($sql) === TRUE) {
